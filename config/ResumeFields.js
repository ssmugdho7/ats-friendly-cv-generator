...
export default {
    ...
    typography: {
        ...
        fields: [
            ...
            { name: 'nameSize', label: 'Name Size', type: 'number', placeholder: '20', min: 8, max: 72 },
            { name: 'titleSize', label: 'Section Title Size', type: 'number', placeholder: '13', min: 8, max: 48 },
            { name: 'titleWeight', label: 'Section Title Weight', type: 'select', options: [
                { value: 'normal', name: 'Normal' },
                { value: 'bold', name: 'Bold' },
            ]},
            { name: 'breakerSize', label: 'Section Breaker Thickness', type: 'number', placeholder: '1', min: 0, max: 10 },
            { name: 'sectionBreakerColor', label: 'Section Breaker Color', type: 'color', placeholder: '#e0e0e0' },
            { name: 'size', label: 'Body Font Size', type: 'number', placeholder: '10', min: 6, max: 24 },
            { name: 'descSize', label: 'Description Font Size', type: 'number', placeholder: '10', min: 6, max: 24 },
            { name: 'companySize', label: 'Company/Institution Size', type: 'number', placeholder: '10', min: 6, max: 24 },
            { name: 'roleSize', label: 'Role/Project Title Size', type: 'number', placeholder: '12', min: 6, max: 24 },
            { name: 'sectionMarginBefore', label: 'Space Before Section', type: 'number', placeholder: '0', min: 0, max: 100 },
            { name: 'sectionMarginAfter', label: 'Space After Section', type: 'number', placeholder: '0', min: 0, max: 100 },
